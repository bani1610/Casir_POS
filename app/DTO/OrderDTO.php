...
class OrderDTO
{
    /**
     * @param int|null $id
     * @param int|null $userId User yang membuat order
(karyawan/admin). Null untuk self-order pembeli.
     * @param int|null $paymentMethodId Metode pembayaran.
Nullable saat pending.
     * @param string|null $tableNumber Nomor meja (untuk
dine-in). Nullable untuk self-order.
     * @param string|null $customerIdentifier Device
fingerprint untuk self-order pembeli (24 jam session).
     ...
     * @param array $items Array of OrderItemDTO untuk order
items.
     */
